                  ...
                  <div className="relative w-full h-full">
                    {items.map((it) => (
                      ...
                      >
                        {isGold ? (
                          <div
                            className="w-6 h-6 rounded-full border border-yellow-200/80 flex items-center justify-center text-[8px] font-bold text-yellow-900"
                            style={{
                              background: "radial-gradient(circle at 30% 30%, hsl(43 100% 75%), hsl(43 80% 50%))",
                          ...
                          <div
                            className="w-7 h-3 rounded-sm border border-slate-200/70"
                            style={{
                              background: "linear-gradient(135deg, hsl(220 15% 90%), hsl(220 10% 65%))",
                              boxShadow: "0 2px 3px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.5)",
                            }}
                          />
                        )}
                      </motion.div>
